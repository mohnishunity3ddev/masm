...
link %BIN_DIR%\%FILE_NAME%.obj /DEBUG /SUBSYSTEM:console /DEFAULTLIB:kernel32.lib /DEFAULTLIB:user32.lib /DEFAULTLIB:libcmt.lib /OUT:%BIN_DIR%\%FILE_NAME%.exe
